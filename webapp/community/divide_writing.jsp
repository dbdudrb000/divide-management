...
<body class = "divideBoby">
  ...
  <div class="ui_border">
    <h3 class="border_tit">게시글 작성</h3>
    <div class="border_cont" style = "margin-left: 27%;"> 
    <form id = "insertForm" action = "/communityLogic" enctype="multipart/form-data" method = "post">
      	<input type="text" placeholder ="제목" class="inq_field" name = "com_title" required/>
      	     	
      <table border = "8">
     	<i class="fas fa-fan"></i>
 	  </table>
      <!-- <textarea id="" cols="30" rows="8" placeholder = "설명을 입력해주세요." name = "dvDetail"></textarea> -->
      <input type = "text" placeholder = "설명을 입력해주세요." name = "com_detail" style = "height: 350px;">
	</div>
    <div style = "margin-left:27%; margin-top: 5px;">
    	<input type = "text" placeholder = "작성자" value = "${sessionScope.loginVo.nickname}" style ="height:20px; margin-top: 5px;" name = "com_nickname" readonly>
    </div>
	<div class="btn_area">
